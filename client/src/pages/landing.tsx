          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="rounded-[2rem] border-2 p-8 space-y-6 flex flex-col bg-white" style={{ borderColor: PURPLE }}>
              ...
              <button
                ...
                onClick={handleCta}
                className="hidden md:inline-flex w-full py-3 rounded-full text-white font-semibold hover:-translate-y-0.5 hover:bg-[#4C2BC4] transition-all duration-200 shadow-lg shadow-purple-200"
